...
> Else we either sell the stock or hold it.
> This process will only be done once as per the question.
...
> two states for DP as we are updating both index and canBuy variables
...
## Conclusion from above approach is that, it is a bit inefficient and longer code but it is very intuitive and easy to undersand
-> not only that but this template can be used in almost all other buy and sell stock problems with just a few tweaks here and there depending on the question.
